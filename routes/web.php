...
Route::get('/admin', function () {
  ...
  Route::get('/basicinputs', [App\Http\Controllers\Page\PageController::class, 'basicinputs' ])
  ->name('basicinputs');
  Route::get('/inputgroups', [App\Http\Controllers\Page\PageController::class, 'inputgroups' ])
  ->name('inputgroups');
  Route::get('/verticalform', [App\Http\Controllers\Page\PageController::class, 'verticalform' ])
  ->name('verticalform');
  Route::get('/horizontalform', [App\Http\Controllers\Page\PageController::class, 'horizontalform' ])
  ->name('horizontalform');
  Route::get('/tables', [App\Http\Controllers\Page\PageController::class, 'tables' ])
  ->name('tables');